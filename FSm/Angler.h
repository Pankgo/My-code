...
#define HUNGRY_LEVEL			6 // 배고픔 한계
#define THIRST_LEVEL		5	// 갈증 한계.
#define TIREDNESS_THRESHOLD		8	// 피로 한계.
#define COMFORT_LEVEL		50 // 은행 돈
#define COUNT_FISHING		1 // 물고기 잡는데 걸리는 시간 
...
public:
	...
	void EatFish() { if (m_nfish != 0) { m_nfish--; } m_nHungry = 0; } // 배고픔해결
	...
	int Bottle() { return m_nbottle; } // 물병세팅
};